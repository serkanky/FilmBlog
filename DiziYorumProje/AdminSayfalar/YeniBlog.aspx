...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server" class="form-group">
        ...
        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Blog Başlığını Yazın" ></asp:TextBox>
        <br />
        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="Blog Tarihini Yazın" ></asp:TextBox>
        <br />
        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Blog Görseli Ekleyin" ></asp:TextBox>
        <br />
        ...
        <br />
        <asp:Button ID="Button1" runat="server" Text="Yeni Blog Oluştur" CssClass="btn btn-success" OnClick="Button1_Click"/>
    </form>
