        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                         <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "YorumGuncelle.Aspx?YORUMID=" +Eval("YORUMID") %>' CssClass="btn btn-warning">Düzenle</asp:HyperLink>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
